# Estado editorial de Acompañantes - 2026-05-29

## Corte vigente
- versión activa de referencia: `v168-expansion-real-cardiorrenal-tricuspide-ctepd-tos`
- lotes editoriales aplicados: `12`
- registros del catálogo: `927`
...
- `AC-02` ya muestra `4` subfamilias auxiliares.
...
- `AC-10` ya muestra `5` subfamilias auxiliares.
...
`AC-01`, `AC-02`, `AC-03`, `AC-05`, `AC-06`, `AC-07`, `AC-10`, `AC-11` y `AC-13` ya muestran lectura interna auxiliar sin crear filtros nuevos ni alterar el bloque estable de `26` filtros.
